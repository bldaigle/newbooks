...
function getNewBooks(url, container) {
	var getBooks = 
		$.ajax({
	    	...
	    	beforeSend: function() {
	      		$(container).html('<div class="loading"><img srce="http://bendaigle.ohio5.org/dev/newbooks/img/loader.gif" /></div>');
	    	},
	    	dataType: 'json',
	    	success: function(data) {
	      		$.each(data.query.results.rss.channel.item, function(key, value){
	      			...
	      			var defaultCover = '<img src="http://bendaigle.ohio5.org/dev/newbooks/img/book-icon.png" />'
